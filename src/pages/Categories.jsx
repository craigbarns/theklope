...
export default function Categories() {
  ...
  return (
    <div className="container-page py-8">
      <Seo title="Catégories | THEKLOPE" description="Parcourez les catégories THEKLOPE : cigarettes électroniques, pods, e-liquides, produits DIY, accessoires et packs débutants." />
